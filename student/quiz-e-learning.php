                                    ...
                                    <div class="card mb-3 color-bg-200">
                                        <div class="card-body">
                                            <?php if(isset($quiz_done)) : ?>
                                                <h1>
                                                    ANDA SUDAH MENYELESAIKAN QUIZ
                                                </h1>
                                            <?php else : ?>
                                            <form action="../action/save-quiz-e-learning.php" method="POST">
                                                <div class="row align-items-center">
                                                                ...
                                                                <div class="col-11 offset-1">
                                                                    ...
                                                                    foreach ($answer as $key => $a) { ?>
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="question<?php echo $q['id'] ?>" value="<?php echo $a['id'] ?>" required>
                                                                            <label class="form-check-label" for="tipeguru1"><?php echo $a['answer_desc'] ?></label>
                                                                        </div>
                                                                    <?php }
                                                                    ?>
                                                                </div>
                                                    ...
                                                    <div class="row my-1">
                                                        <div class="col-11 offset-1">
                                                            <button type="submit" class="btn btn-primary btn-lg"><b>SIMPAN</b></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
