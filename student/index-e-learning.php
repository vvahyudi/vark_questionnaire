                                ...
                                <div class="col-12 col-xl-12 col-lg-12">
                                    <div class="card mb-3 color-bg-200">
                                        <div class="card-body p-5">
                                                            ...
                                                            foreach ($result as $key => $r) { ?>
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <a href="module-e-learning.php?module=<?php echo $r['id'] ?>" class="text-decoration-none">
                                                                        <div class="card modul mb-3 text-black">
                                                                            <div class="card-body">
                                            ...
                                            ?>
                                            <a href="quiz-e-learning.php" type="submit" class="btn btn-info col-md-12 text-white" <?php if ($learned_module != 7) echo "disabled" ?>>
